  ...
  export default {
    ...
    methods: {
      ...
      getuserbygroup(groupId) {
        ...
        that
          .axios({
            method: "post",
            url: rootPath + "/salesys/user/getbygroup",
            params: {
              groupId: groupId
            }
          })
      ...
      getGroup() {
        ...
        that
          .axios({
            method: "get",
            url: rootPath + "/salesys/user/getGroup"
          })
          .then(response => {
            if (response.data.data) {
              var data = response.data.data;
      ...
      submitReport() {
        ...
        that
          .axios({
            method: "post",
            url: rootPath + "/salesys/report/add",
            params: {
    ...
    submitDiscuss() {
      ...
      that
        .axios({
          method: "post",
          url: rootPath + "/salesys/report/addReportDiscuss",
          params: {
    ...
    queryDiscuss() {
      ...
      that
        .axios({
          method: "post",
          url: rootPath + "/salesys/report/queryDiscuss",
          params: {
            relateid: that.discussId
          }
        })
      ...
      refreshData(startDay, endDay) {
        ...
        that
          .axios({
            method: "post",
            url: rootPath + "/salesys/report/getbygroup",
            params: {
              groupId: groupId,
              startTime: startDay,
              endTime: endDay
