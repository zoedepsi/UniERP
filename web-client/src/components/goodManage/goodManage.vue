<template>
  <div class="page-wrapper">
    <el-row>
      <el-col :span="10">
        <div class="page-title" id="vip-title">商品管理</div>
      </el-col>
      <el-col :span="14">
        <el-button type="primary" style="float:right;margin-right:10px" @click="creategood">添加商品</el-button>
      </el-col>
    </el-row>
      ...
      <el-table :data="tableData" stripe style="width: 100%">
        ...
        <el-table-column label="操作" width="150">
          <template slot-scope="scope">
            <el-button type="primary" size="small" @click="editgood(scope.row.id)">编辑</el-button>
            <el-button type="danger" size="small" @click="delgood(scope.row.id)">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
    </div>
    <el-dialog title="商品创建" :visible.sync="dialogVisible">
      <el-form :model="createForm" :rules="rules" ref="createForm" label-width="80px">
        <el-form-item label="商品名称" prop="name">
          <el-input v-model="createForm.name"></el-input>
        </el-form-item>
        <el-form-item label="所属分类" prop="class">
          <el-select v-model="createForm.class" placeholder="请选择分类">
        ...
        <el-form-item label="销售价格" prop="price">
          <el-input type='number' v-model="createForm.price"></el-input>
        </el-form-item>
      </el-form>
    ...
    <el-dialog title="分类编辑" :visible.sync="dialogVisible2">
      <el-form :model="editForm" :rules="rules" ref="editForm" label-width="80px">
        ...
        <el-form-item label="所属分类" prop="class">
          <el-select v-model="editForm.class" placeholder="请选择分类">
            <el-option v-for="item in classes" :key="item.id" :label="item.name" :value="item.id"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="单位" prop="unit">
